...
async def upload_blob(blob,pathname,path:Path,ctype:str):
    return await blob.put(pathname,path.read_bytes(),access="public",add_random_suffix=True,multipart=True,content_type=ctype)
